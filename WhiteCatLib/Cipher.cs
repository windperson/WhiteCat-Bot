...
namespace WhiteCatLib
{
    public class Cipher
    {
        public static string DEFAULT_IV_128 = "=q$f]p&(K.3_#hHk";
        public static string DEFAULT_NETWORKHASH = "Y.u=M,N-!8Jd2`RXE)k!]y<w2TFg-[4Z";
        ...
        public static string Decrypt(string body, bool gziped , string key)
        {
            if(gziped)
            {
                return GzUncompress(DecryptRJ128Byte(key, Cipher.DEFAULT_IV_128, body));
            }
            else
            {
                return DecryptRJ128(key, Cipher.DEFAULT_IV_128, body);
            }
        }
    }
}
